...
public class AutomataNoDeterminista {
	...
	public AutomataNoDeterminista(String alfabeto) {
	...
	public AutomataDeterminista toDeterministic() {
		...
		AutomataDeterminista newDet = new AutomataDeterminista(this.alfabeto);
