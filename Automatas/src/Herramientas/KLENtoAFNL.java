        ...
        if (uni == 0) {
            ...
            switch (ex) {
                ...
                case 'U':
                    ...
                    cad.get("Separations").add("0P:$>" + "P" + cad1.get("ini").get(0) + ";U" + cad2.get("ini").get(0));
